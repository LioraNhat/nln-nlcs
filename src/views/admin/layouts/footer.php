<footer class="app-footer">
            <div class="float-end d-none d-sm-inline">NLN_NLCS Project</div>
            <strong>
                Copyright &copy; 2025&nbsp;
                <a href="#" class="text-decoration-none">GreenMeal</a>.
            </strong>
            All rights reserved.
        </footer>
    ...
    <script src="<?php echo BASE_PATH; ?>/admin_assets/js/adminlte.js"></script>
