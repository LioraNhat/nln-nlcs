...
<head>
    ...
    <title>Quản trị Admin | GreenMeal</title>
...
<ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-md-block">
        <a href="<?php echo BASE_PATH; ?>/" class="nav-link">Xem Website</a>
    </li>
</ul>
...
<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
    <img src="<?php echo BASE_PATH; ?>/admin_assets/assets/img/user2-160x160.jpg"
         class="user-image rounded-circle shadow"
         alt="User Image" />

    <!-- SỬA HO_TEN -> ho_ten -->
    <span class="d-none d-md-inline">
        <?php echo $_SESSION['user']['ho_ten'] ?? 'Admin'; ?>
    </span>
</a>
...
<li class="user-footer">
    <a href="<?= BASE_PATH ?>/admin/profile" class="btn btn-default btn-flat">
        Hồ sơ
    </a>
    ...
    <form id="logout-form"
          action="<?php echo BASE_PATH; ?>/auth/logout"
          method="POST"
          style="display:none;">
    </form>
</li>
