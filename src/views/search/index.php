...
<div class="container">
    <main class="product-listing-page">
        ...
        <h2 class="search-results-heading">
            <?php if (!empty(trim($searchTerm))): ?>
                Kết quả tìm kiếm cho: "<?php echo htmlspecialchars($searchTerm); ?>"
            <?php else: ?>
        ...
        <div class="product-grid">
            ...
            ?>
                <p style="grid-column: 1 / -1; text-align: center; padding: 40px;">Không tìm thấy sản phẩm nào phù hợp.</p>
            <?php 
            endif; 
            ?>
        </div>
